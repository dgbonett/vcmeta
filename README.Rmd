...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/vcmeta)](https://CRAN.R-project.org/package=vcmeta)
...
You can install the released version of vcmeta from [CRAN](https://CRAN.R-project.org) with:
...
Submit feedback, suggestions, and bugs to github [here](https://github.com/dgbonett/vcmeta/issues/new).  
